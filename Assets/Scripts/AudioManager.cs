...
public class AudioManager : MonoBehaviour
{
    ...
    void Awake()
    {
        foreach (Sound sound in sounds)
        {
            ...
            else if (sound.group == "PlayerDeath")
            {
                sound.source.outputAudioMixerGroup = playerGroup;
            }
            else if (sound.group == "EnemyDeath")
            {
                sound.source.outputAudioMixerGroup = enemyGroup;
            }
            else
            {
                sound.source.outputAudioMixerGroup = foleyGroup;
